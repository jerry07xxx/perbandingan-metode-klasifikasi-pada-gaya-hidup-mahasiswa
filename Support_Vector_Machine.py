...
# 6. Inisialisasi dan latih model Support Vector Machine (SVM)
print("\nTraining SVM model...")
model = SVC(random_state=42)  # Anda dapat menyesuaikan parameter kernel jika diperlukan (linear, rbf, dll)
